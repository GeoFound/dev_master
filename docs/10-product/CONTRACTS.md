...
|--------|----------------|-------------------|
| `software_change_request` | active concept | `docs/20-current-window/17-task-templates.md`, `docs/20-current-window/18-master-execution-task.md` |
| `software-change-runner-v2` | rewrite target | `docs/20-current-window/REWRITE-PLAN.md` |
| `verifier_decision` | active concept | `docs/10-product/05-quality.md` |
| `evidence_writeback` | active concept | `docs/30-integrations/23-menmery-integration.md`, `docs/30-integrations/27-external-systems-boundary.md` |
| `autonomy_ratchet_decision` | active concept | `docs/20-current-window/autonomy-ratchet.md` |
| `human_review_inbox_item` | active concept | `docs/20-current-window/human-review-inbox.md` |
| `cost_ceiling_facts` | active concept | `docs/20-current-window/cost-ceilings.md` |
| `ratchet_metrics_contribution` | active concept | `docs/20-current-window/autonomy-ratchet.md` |
| `engineering_boundary_classification` | active concept | `docs/10-product/engineering-execution-boundaries.md` |
| `task_proposal` | active concept | `docs/10-product/task-proposal-contract.md` |
| `dev_master_decision` | active concept | `docs/10-product/task-proposal-contract.md` |
| `provider_adapter_output` | active concept | `docs/10-product/product-architecture-decision.md` |
| `adapter_run` | deferred/future | `docs/40-future/12-disaster-recovery.md` |
| `gateway_request_result_feedback` | future integration audit concept | `docs/40-future/12-disaster-recovery.md`, `docs/20-current-window/REWRITE-PLAN.md` |
