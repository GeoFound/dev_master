...
The recovered v3 design is outdated historical context for broader tool ideas.
Current implementation must still be gated by
[26-design-closure-review.md](26-design-closure-review.md) and a human-approved
rewrite plan.
...
Machine-readable cost-bearing artifacts should also follow `CONTRACTS.md`.

---

## Upgrade And Reduction Triggers

The recovered v3 trigger logic is still worth keeping at the policy level:
